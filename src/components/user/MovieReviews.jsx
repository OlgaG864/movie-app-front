...
export default function MovieReviews() {
  ...
  return (
    <div className="dark:bg-main min-h-screen pb-10">
      <Container className="xl:px-0 px-2 py-8">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-semibold dark:text-white text-second">
        ...
        {profileOwnersReview ? (
          <div>
            ...
            <div className="flex space-x-3 dark:text-white text-main text-xl p-3">
...
const ReviewCard = ({ review }) => {
  ...
  return (
    <div className="flex space-x-3">
      ...
      <div>
        <h1 className="dark:text-white text-second font-semibold text-lg">
          {owner.name}
        </h1>
